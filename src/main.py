...
def index():
    ...
    """
    res = bypassflare_service.index_endpoint()
...
def health():
    ...
    """
    res = bypassflare_service.health_endpoint()
    return utils.object_to_dict(res)
...
def controller_v1():
    ...
    res = bypassflare_service.controller_v1_endpoint(req)
...
if __name__ == "__main__":
    ...
    logging.info(f'BypassFlare {utils.get_bypassflare_version()}')
    logging.debug('Debug log enabled')

    # test browser installation
    bypassflare_service.test_browser_installation()
